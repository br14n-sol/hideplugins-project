...
public class Utils {
    ...
    public static List<String> toList(String paramString){
        return new ArrayList<>(Arrays.asList(paramString.replace(" ", "").split(",")));
    }
    public static String toString(List<String> paramList){
        if(paramList.size() > 1){
